...
export function VehicleTypeForm({
  ...
  const Label = ({ children }: { children: React.ReactNode }) => (
    <div className="text-sm font-medium pb-1">{children}</div>
  );
        ...
        <table className="w-full border-collapse">
          <tbody>
            ...
            <tr>
              ...
              <td className="border p-2">
                <div className="space-y-1">
                  <Label>Fuel Price Per Litre (AED)</Label>
                  <Input
                    type="number"
                    step="0.01"
            ...
            <tr>
              <td className="border p-2">
                <div className="space-y-1">
                  <Label>Idle Fuel Consumption</Label>
                  <Input
                    type="number"
                    step="0.01"
              ...
              <td className="border p-2">
                <div className="space-y-1">
                  <Label>CO2 Emission Factor</Label>
                  <Input
                    type="number"
                    step="0.01"
            ...
            <tr>
              ...
              <td className="border p-2">
                <div className="space-y-1">
                  <Label>Alert Before Value (KM)</Label>
                  <Input
                    type="number"
