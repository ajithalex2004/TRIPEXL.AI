...
const GoogleMapView = ({
  ...
  const toggleTraffic = useCallback(() => {
    ...
    if (!showTraffic) {
      ...
      newTrafficLayer.setMap(mapInstance);
  ...
  }, [mapInstance, showTraffic, pickupLocation, dropoffLocation, trafficLayer]);
  ...
  }, [mapInstance, pickupLocation, dropoffLocation, waypoints]);
  ...
  const selectAsPickup = useCallback(() => {
  ...
  const selectAsDropoff = useCallback(() => {
    if (clickedLocation && onLocationSelect) {
